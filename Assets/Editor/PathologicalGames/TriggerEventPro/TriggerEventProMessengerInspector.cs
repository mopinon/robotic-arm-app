...
public class TriggerEventProMessengerInspector : Editor
{
	...
	public override void OnInspectorGUI()
    {
		...
		// EnumFlagsField returns an Enum that has to be cast back to our type before casting to int
		var forCompFlags = (TriggerEventProMessenger.COMPONENTS)this.forComponent.intValue;
        System.Enum result = EditorGUILayout.EnumFlagsField(content, forCompFlags);
