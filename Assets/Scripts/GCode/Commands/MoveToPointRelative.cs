...
{
    public class MoveToPointRelative : IGCommand
    {
        ...
        public MoveToPointRelative(Params @params)
        {
            _parameters = @params;
        }
        ...
        public IEnumerator Execute()
        {
            ...
            var position = _parameters.Tool.position;
            var to = _parameters.FinalPosition / 1000f + position;
            var ccdik = _parameters.Target.GetComponent<CCDIK>();

            ccdik.enabled = true;
            _parameters.Point.position = position;
