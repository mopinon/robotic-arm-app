...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        [Tooltip("Should the scale of the droppable object revert to its original value ? Can help avoid scaling issues at different screen resolutions.")]
        public bool SetIniialScaleOnDrop = true;

        public bool destroyOutOfSpace = false;
        ...
        private Vector2 _draggingObjectOriginalScale;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            _draggingObjectOriginalScale = gameObject.GetComponent<RectTransform>().localScale;
            ...
            if (SetIniialScaleOnDrop)
                _draggingObject.localScale = _draggingObjectOriginalScale;
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (_draggingObject != null)
            {
                ...
                {
                    if (!_reorderableList.CloneDraggedObject) Destroy(gameObject);
                     _isDragging = false;
        ...
        private void RefreshSizes()
        {
            ...
            if (_currentReorderableListRaycasted != null && _currentReorderableListRaycasted.IsDropable && _currentReorderableListRaycasted.Content.childCount > 0)
            {
                ...
                if (_currentReorderableListRaycasted.IsFirstChildSetSize && firstChild != null)
                {
